...
- Project Creation (https://deepwiki.com/elizaOS/eliza/3.2-project-creation)
...
Sources: packages/plugin-bootstrap/package.json295-313 packages/core/package.json253-281 packages/plugin-sql/package.json345-366

# User Interface - Agent Configuration

## Overview
Configuration and guidelines for AI agents working with user interface in user context.

## Agent Profile

### Role Definition
- **Primary Role**: user interface specialist
...
- **Domain Expertise**: user interface specific

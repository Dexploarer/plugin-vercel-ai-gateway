# Getting Started - Agent Configuration

## Overview
Configuration and guidelines for AI agents working with getting started in user context.

## Agent Profile

### Role Definition
- **Primary Role**: getting started specialist
...
- **Domain Expertise**: getting started specific

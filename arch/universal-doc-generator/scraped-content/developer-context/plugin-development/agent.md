# Plugin Development - Agent Configuration

## Overview
Configuration and guidelines for AI agents working with plugin development in developer context.

## Agent Profile

### Role Definition
- **Primary Role**: plugin development specialist
...
- **Domain Expertise**: plugin development specific

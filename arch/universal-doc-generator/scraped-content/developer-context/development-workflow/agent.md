# Development Workflow - Agent Configuration

## Overview
Configuration and guidelines for AI agents working with development workflow in developer context.

## Agent Profile

### Role Definition
- **Primary Role**: development workflow specialist
...
- **Domain Expertise**: development workflow specific

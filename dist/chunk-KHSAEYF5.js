...
function getAppName(runtime) {
  return getSetting(runtime, "AI_GATEWAY_APP_NAME") || runtime.character?.name || "ElizaOS-Agent";
}
...
var GatewayProvider = class {
  ...
  async generateTextSmallStreaming(runtime, params) {
    const { StreamingGatewayProvider } = await import("./streaming-gateway-provider-OCMHCNUR.js");

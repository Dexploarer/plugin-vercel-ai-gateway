...
var _a;
var _a2;
var _AISDKError = (_a2 = class extends Error {
  /**
  ...
  static isInstance(error) {
    return _a2.hasMarker(error, marker);
  }
  static hasMarker(error, marker15) {
    const markerSymbol = Symbol.for(marker15);
    return error != null && typeof error === "object" && markerSymbol in error && typeof error[markerSymbol] === "boolean" && error[markerSymbol] === true;
  }
}, __name(_a2, "_AISDKError"), _a2);
_a = symbol;
...
var _a22;
var _a3;
var APICallError = (_a3 = class extends AISDKError {
  constructor({
    message,
    url,
    requestBodyValues,
...
var _a32;
var _a4;
var EmptyResponseBodyError = (_a4 = class extends AISDKError {
  // used in isInstance
...
}, __name(_a4, "EmptyResponseBodyError"), _a4);
_a32 = symbol3;
...
var _a42;
var _a5;
var InvalidArgumentError = (_a5 = class extends AISDKError {
  constructor({
    message,
    cause,
    argument
...
}, __name(_a5, "InvalidArgumentError"), _a5);
_a42 = symbol4;
...
var _a52;
var _a6;
var InvalidPromptError = (_a6 = class extends AISDKError {
  constructor({
    prompt,
    message,
    cause
...
}, __name(_a6, "InvalidPromptError"), _a6);
_a52 = symbol5;
...
var _a62;
var _a7;
var InvalidResponseDataError = (_a7 = class extends AISDKError {
  constructor({
    data,
...
}, __name(_a7, "InvalidResponseDataError"), _a7);
_a62 = symbol6;
...
var _a72;
var _a8;
var JSONParseError = (_a8 = class extends AISDKError {
...
var _a82;
var _a9;
var LoadAPIKeyError = (_a9 = class extends AISDKError {
  // used in isInstance
  constructor({ message }) {
...
}, __name(_a9, "LoadAPIKeyError"), _a9);
_a82 = symbol8;
...
var _a12;
var _a13;
var TooManyEmbeddingValuesForCallError = (_a13 = class extends AISDKError {
  constructor(options) {
    super({
      name: name11,
...
}, __name(_a13, "TooManyEmbeddingValuesForCallError"), _a13);
_a12 = symbol12;
...
var _a132;
var _a14;
var _TypeValidationError = (_a14 = class extends AISDKError {
...
Error message: ${getErrorMessage(cause)}`,
  ...
  static wrap({
    ...
    return _a14.isInstance(cause) && cause.value === value ? cause : new _a14({ value, cause });
  }
}, __name(_a14, "_TypeValidationError"), _a14);
_a132 = symbol13;
...
var _a142;
var _a15;
var UnsupportedFunctionalityError = (_a15 = class extends AISDKError {
  constructor({
    functionality,
...
}, __name(_a15, "UnsupportedFunctionalityError"), _a15);
_a142 = symbol14;
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "image_url",
                  image_url: {
                    url: part.image instanceof URL ? part.image.toString() : `data:${(_a24 = part.mimeType) != null ? _a24 : "image/jpeg"};base64,${convertUint8ArrayToBase64(part.image)}`,
...
function mapOpenAIChatLogProbsOutput(logprobs) {
  var _a24, _b;
  return (_b = (_a24 = logprobs == null ? void 0 : logprobs.content) == null ? void 0 : _a24.map(({ token, logprob, top_logprobs }) => ({
    token,
    logprob,
...
function prepareTools({
  ...
  var _a24;
  const tools = ((_a24 = mode.tools) == null ? void 0 : _a24.length) ? mode.tools : void 0;
  const toolWarnings = [];
  if (tools == null) {
...
var _a16;
var OpenAIChatLanguageModel = (_a16 = class {
  ...
  get supportsStructuredOutputs() {
    var _a24;
    return (_a24 = this.settings.structuredOutputs) != null ? _a24 : isReasoningModel(this.modelId);
  }
    ...
    const baseArgs = {
      ...
      response_format: (responseFormat == null ? void 0 : responseFormat.type) === "json" ? this.supportsStructuredOutputs && responseFormat.schema != null ? {
        ...
        json_schema: {
          ...
          strict: true,
          name: (_a24 = responseFormat.name) != null ? _a24 : "response",
  ...
  async doGenerate(options) {
    ...
    const completionTokenDetails = (_a24 = response.usage) == null ? void 0 : _a24.completion_tokens_details;
        ...
        new TransformStream({
          ...
          flush(controller) {
            ...
            controller.enqueue({
              ...
              logprobs,
              usage: {
                promptTokens: (_a24 = usage.promptTokens) != null ? _a24 : NaN,
...
}, __name(_a16, "OpenAIChatLanguageModel"), _a16);
...
function getSystemMessageMode(modelId) {
  ...
  return (_b = (_a24 = reasoningModels[modelId]) == null ? void 0 : _a24.systemMessageMode) != null ? _b : "developer";
}
...
var _a17;
var OpenAICompletionLanguageModel = (_a17 = class {
  constructor(modelId, settings, config) {
    this.specificationVersion = "v1";
  ...
  getArgs({
    ...
    switch (type) {
      case "regular": {
        if ((_a24 = mode.tools) == null ? void 0 : _a24.length) {
          throw new UnsupportedFunctionalityError({
            functionality: "tools"
          });
        }
...
}, __name(_a17, "OpenAICompletionLanguageModel"), _a17);
...
var _a18;
var OpenAIEmbeddingModel = (_a18 = class {
  constructor(modelId, settings, config) {
    this.specificationVersion = "v1";
    this.modelId = modelId;
    this.settings = settings;
  ...
  get maxEmbeddingsPerCall() {
    var _a24;
    return (_a24 = this.settings.maxEmbeddingsPerCall) != null ? _a24 : 2048;
  }
  get supportsParallelCalls() {
    var _a24;
    return (_a24 = this.settings.supportsParallelCalls) != null ? _a24 : true;
  }
  async doEmbed({
    values,
    headers,
...
}, __name(_a18, "OpenAIEmbeddingModel"), _a18);
...
var _a19;
var OpenAIImageModel = (_a19 = class {
  constructor(modelId, settings, config) {
    this.modelId = modelId;
    this.settings = settings;
    this.config = config;
  ...
  get maxImagesPerCall() {
    var _a24, _b;
    return (_b = (_a24 = this.settings.maxImagesPerCall) != null ? _a24 : modelMaxImagesPerCall[this.modelId]) != null ? _b : 1;
  }
  get provider() {
    return this.config.provider;
  }
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a24 = this.config._internal) == null ? void 0 : _a24.currentDate) == null ? void 0 : _b.call(_a24)) != null ? _c : /* @__PURE__ */ new Date();
...
}, __name(_a19, "OpenAIImageModel"), _a19);
...
var _a20;
var OpenAITranscriptionModel = (_a20 = class {
  ...
  getArgs({
    ...
    if (openAIOptions) {
      const transcriptionModelOptions = {
        include: (_a24 = openAIOptions.include) != null ? _a24 : void 0,
...
}, __name(_a20, "OpenAITranscriptionModel"), _a20);
          ...
          content: content.map((part, index) => {
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "input_image",
                  image_url: part.image instanceof URL ? part.image.toString() : `data:${(_a24 = part.mimeType) != null ? _a24 : "image/jpeg"};base64,${convertUint8ArrayToBase64(part.image)}`,
                  // OpenAI specific extension: image detail
                  detail: (_c = (_b = part.providerMetadata) == null ? void 0 : _b.openai) == null ? void 0 : _c.imageDetail
                };
              }
...
var _a21;
var OpenAIResponsesLanguageModel = (_a21 = class {
  constructor(modelId, config) {
    this.specificationVersion = "v1";
  ...
  getArgs({
    ...
    const isStrict = (_a24 = openaiOptions == null ? void 0 : openaiOptions.strictSchemas) != null ? _a24 : true;
    const baseArgs = {
      model: this.modelId,
      input: messages,
      temperature,
  ...
  async doGenerate(options) {
    ...
    const reasoningSummary = (_b = (_a24 = response.output.find((item) => item.type === "reasoning")) == null ? void 0 : _a24.summary) != null ? _b : null;
    return {
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              finishReason = mapOpenAIResponseFinishReason({
                finishReason: (_a24 = value.response.incomplete_details) == null ? void 0 : _a24.reason,
                hasToolCalls
              });
...
}, __name(_a21, "OpenAIResponsesLanguageModel"), _a21);
...
var _a23;
var OpenAISpeechModel = (_a23 = class {
  constructor(modelId, config) {
    this.modelId = modelId;
    this.config = config;
    this.specificationVersion = "v1";
...
}, __name(_a23, "OpenAISpeechModel"), _a23);
function createOpenAI(options = {}) {
  var _a24, _b, _c;
  const baseURL = (_a24 = withoutTrailingSlash(options.baseURL)) != null ? _a24 : "https://api.openai.com/v1";
